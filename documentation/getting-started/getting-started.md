...
{% hint style="info" %}
If you're evaluating the platform for your team rather than yourself, jump to [Core concepts](https://app.gitbook.com/s/UmkMM7tBGa2Sva5Hif5v/core-concepts "mention") first — it'll save time when you set things up properly.
{% endhint %}
